...
describe("Image Gallery => Default View", () => {
  it('the photos in the gallery are specific to the currently selected product style', () => {
...
describe("Image Gallery => Expanded View", () => {
  it('the expanded view of the image gallery should overlay the rest of the item detail page', () => {
    expect().toBeInTheDocument();
  });
